...
#             ***Very Important Conclusion : we will move in that direction due to which our element got fail for becoming
#              peak element. if next element is greater than array[mid] we will move to right i.e. start = mid + 1 if prev
